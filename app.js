...
function normalizeTasks(rawTasks) {
    ...
    const CORE_MAP = {
        '🌿Nature': 'nature', '⚡Action': 'acting', 
        '🌙Reflective': 'reflecting', '✨Creative': 'creating'
    };
    const STAGE_MAP = {
...
function populateFilterUI() {
    ...
    const options = {
        core: [
            { raw: '🌿Nature', cleaned: 'nature' },
            { raw: '⚡Action', cleaned: 'acting' },
            { raw: '🌙Reflective', cleaned: 'reflecting' },
            { raw: '✨Creative', cleaned: 'creating' },
        ],
        stage: [
